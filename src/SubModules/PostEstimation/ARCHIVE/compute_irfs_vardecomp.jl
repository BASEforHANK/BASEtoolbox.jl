...
function compute_irfs_vardecomp(models, select_variables)
    ...
    for j = 1:n_models
        ...
        for i in select_variables
            ...
            #= This part throws something like "Any[1781, 1784, 1788]" if the variable in select_variables is not defined.
                In this case the plotted IRF is a flat line at 0. =#
            try
