...
F[indexes.K] = log(LPXA) - XSS[indexes.LPXASS] # One Asset Model: the expected liquidity premium is constant
F[indexes.B] = K * qlag + B - TotalAssets  # Accounting for total assets
